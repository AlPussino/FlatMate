      ...
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            Column(
              children: [
                TextFormFields(isEmail: true),
                const SizedBox(height: 20),
                TextFormFields(isEmail: false)
              ],
            ),
            ...
            Column(
              ...
              children: [
                ElevatedButton(
                  onPressed: () async {
                    if (context.read<LogInProvider>().isLogInButtonDisable !=
                        true) {
                      if (context
                          .read<LogInProvider>()
                          .isEmailAndPasswordFilled) {
                        context.read<LogInProvider>().loginIn(true);
                        context.read<LogInProvider>().disableLoginButton(true);
                        context.read<LogInProvider>().unFocusNodes();

                        ///
                        await Future.delayed(Duration(seconds: 1));
                        String deviceId =
                            await context.read<TokenProvider>().getDeviceId();
                        ...
                        context.read<LogInProvider>().disableLoginButton(false);
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor:
                        context.watch<LogInProvider>().isEmailAndPasswordFilled
